/* 306A Exam Simulator, Application Logic */

const ACCESS_CODE  = "306A9000";
const EXAM_SECONDS = 14400;
const PASSING_PCT  = 70;
const STORAGE_KEY  = "306a_exam_state_v1";
const SIM_Q_COUNT  = 125;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const CLUSTER_LABEL = "Case";
const DOMAIN_LABELS = {"performs_common_occupational_skills": "Performs Common Occupational Skills", "prepares_and_assembles_tube_tubing_and_pipe": "Prepares and Assembles Tube Tubing and Pipe", "installs_tests_and_services_sewers_sewage_treatment_and_dwv_systems": "Installs Tests and Services Sewers Sewage Treatment and DWV Systems", "installs_tests_and_services_water_service_and_distribution": "Installs Tests and Services Water Service and Distribution", "installs_tests_and_services_fixtures_appliances_and_water_treatment_systems": "Installs Tests and Services Fixtures Appliances and Water Treatment Systems", "installs_tests_and_services_low_pressure_steam_and_hydronic_systems": "Installs Tests and Services Low-Pressure Steam and Hydronic Systems", "installs_tests_and_services_specialized_systems": "Installs Tests and Services Specialized Systems"};  // maps domain key -> human-readable label for display
